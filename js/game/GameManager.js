...
export class GameManager {
    ...
    initializeGame() {
        ...
        this.grid.generateTerrain(this.gameMode);
        
        // Calculer les zones constructibles initiales
        const goldenCells = this.grid.updateCannonZones(1);
        this.currentPlayer.cannonQuota = this.grid.calculateCannonQuota(goldenCells);
        
        this.updateUI();
        
        console.log('🎮 Game initialized - Mode:', this.gameMode);
        console.log('🏰 Golden cells found:', goldenCells);
        console.log('🔫 Cannon quota:', this.currentPlayer.cannonQuota);
    }
    ...
    startPlaceCanonsPhase() {
        this.showPhaseModal('PLACEMENT DES CANONS', 'Placez vos canons dans les zones dorées');
        
        // Compter les cases dorées actuelles et calculer le quota de canons
        const goldenCells = this.grid.countGoldenCells();
        this.currentPlayer.cannonQuota = this.grid.calculateCannonQuota(goldenCells);
        
        console.log('🔫 Place Cannons Phase - Quota:', this.currentPlayer.cannonQuota);
    }
